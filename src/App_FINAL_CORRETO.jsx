...
const USER_ID = "joao_gabriel_cojur";

/* === SUPABASE CLIENT === */
var _supabase = null;
try {
  var _sUrl = "https://vcxastdcsbzdsfcdbtan.supabase.co";
  var _sKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjeGFzdGRjc2J6ZHNmY2RidGFuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU3MjEzMTEsImV4cCI6MjA5MTI5NzMxMX0.DooE1OfcYeDnTor1d40N6ndTnUtP3U7waNkB8tqQn-k";
  var _createClient = function(url, key){
        ...
        return {
          select: function(cols){ return {
            eq: function(col, val){ return {
              single: function(){
                return fetch(url+"/rest/v1/"+table+"?"+col+"=eq."+val+"&select="+cols, {headers:headers})
  ...
  _supabase = _createClient(_sUrl, _sKey);
} catch(e) {}
...
var dbGet = async function(){
  ...
  if(_supabase){
    try{
      var res = await _supabase.from("nexus_state").select("data").eq("user_id", USER_ID).single();
      if(!res.error && res.data && res.data.data) {
        try{ localStorage.setItem(STORE_KEY, res.data.data); }catch(e){}
...
var dbSet = async function(value){
  ...
  if(_supabase){
    try{
      fetch("https://vcxastdcsbzdsfcdbtan.supabase.co/rest/v1/nexus_state", {
        method:"POST",
        headers:{"apikey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjeGFzdGRjc2J6ZHNmY2RidGFuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU3MjEzMTEsImV4cCI6MjA5MTI5NzMxMX0.DooE1OfcYeDnTor1d40N6ndTnUtP3U7waNkB8tqQn-k","Authorization":"Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjeGFzdGRjc2J6ZHNmY2RidGFuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU3MjEzMTEsImV4cCI6MjA5MTI5NzMxMX0.DooE1OfcYeDnTor1d40N6ndTnUtP3U7waNkB8tqQn-k","Content-Type":"application/json","Prefer":"resolution=merge-duplicates"},
        body:JSON.stringify({user_id:USER_ID, data:value, updated_at:new Date().toISOString()})
      }).catch(function(){});
    }catch(e){}
  }
};
...
/* ═══ REDUCER ═══ */
const mkInit=()=>({adm:D_ADM,jud:D_JUD,reun:D_REUN,sust:D_SUST,viag:D_VIAG,inbox:D_INBOX,realizados:[],notas:[],lembretes:[]});
