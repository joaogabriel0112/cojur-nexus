...
var getPecaLabel = function(tp){
  var abbrev = {
    "Contestação":"CONTEST.","Apelação":"APEL.","Apelação Adesiva":"APEL.ADES.",
    "Agravo de Instrumento":"AG.INST.","Agravo Retido":"AG.RET.","Agravo Interno":"AG.INT.",
    "Embargos de Declaração":"EMBS.DEC.","Embargos Infringentes":"EMBS.INF.","Embargos de Divergência":"EMBS.DIV.",
    "Recurso Especial":"RESP","Agravo em Recurso Especial":"AG.RESP",
    "Recurso Extraordinário":"RE","Agravo em Recurso Extraordinário":"AG.RE","Recurso Ordinário Constitucional":"ROC",
    "Informações em MS":"INFO.MS","Contrarrazões":"CTR.RAZ.","Contraminuta":"CTR.MIN.",
    "Impugnação ao Cumprimento de Sentença":"IMP.CUM.","Exceção de Pré-Executividade":"EXC.PRE.",
    "Embargos à Execução":"EMBS.EX.","Embargos de Terceiro":"EMBS.TER.",
    "Manifestação sobre Tutela":"TUTE.","Pedido de Efeito Suspensivo":"EF.SUSP.","Petição Cautelar":"CAU.",
    "Manifestação":"MANIF.","Petição Simples":"PET.","Memorial":"MEM.","Memoriais":"MEM.",
    "Alegações Finais":"ALEG.FIN.","Razões de Recurso":"RAZ.REC.","Contrarrazões de Recurso":"CTR.REC.",
    "Sustentação Oral":"SUST.","Cumprimento de Sentença":"CUM.SENT.","Impugnação ao Cumprimento":"IMP.CUM.",
    "Cálculos de Liquidação":"CALC.","Parecer Jurídico":"PARECER","Ofício":"OFICIO",
    "Nota Técnica":"NT","Despacho de Andamento":"DESP.","Reconvenção":"RECONV.","Exceção de Incompetência":"EXC.INC."
  };
  return abbrev[tp] || (tp ? tp.substring(0,8).toUpperCase() : "—");
};
